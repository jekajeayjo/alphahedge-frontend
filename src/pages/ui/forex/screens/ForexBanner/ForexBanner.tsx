    ...
    <Container>
      <div className={s.content}>
        <div className={s.desc}>
          ...
          <p className={s.text}>
            Если вы тоже задаетесь подобными вопросами, вы не одиноки. Ежегодно
            сотни тысяч людей самых разных возрастов делают свои первые шаги в
            инвестициях. Все эти финансовые понятия могут показаться сложными,
            если вы никогда раньше не инвестировали.
          </p>
          <p className={s.text}>
